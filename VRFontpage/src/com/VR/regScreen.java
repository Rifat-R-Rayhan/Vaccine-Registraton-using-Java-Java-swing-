        ...
        btn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    ...
                    ResultSet rs = st.executeQuery("SELECT * FROM brn_holder_information");
                    ...
                    if(user.equals("") || contact.equals("") || dob.equals("") || age1.equals("") || loc.equals("") || nationality.equals("") || center.equals("")){
                        ...
                        if(count == 0){
                            String command = "INSERT INTO brn_holder_information(Name, Phone, Reg_No, DOB, Location, Nationality, Center, Reg_Date) VALUES('"+user+"','"+contact+"', '"+dob+"', '"+age1+"', '"+nationality+"', '"+loc+"','"+center+"', CURDATE())";
                            st.execute(command);
