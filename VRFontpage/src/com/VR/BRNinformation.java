...
public class BRNinformation {
    public JPanel BRNinfoPanel;
    JPanel panel;
    ...
    public void BRNRegScreen() {
        this.BRNinfoPanel = new JPanel();
        this.BRNinfoPanel.setLayout(null);
        this.BRNinfoPanel.setBounds(0, 0, 1650, 1080);
        this.BRNinfoPanel.setBackground(Color.LIGHT_GRAY);
        ...
        this.BRNinfoPanel.add(homepage);
        ...
        text.setText("This is a BRN_Holder_Information Table");
        text.setFont(new Font("Algerian", Font.BOLD, 20));
        text.setBounds(550, 15, 1650, 100);
        text.setForeground(Color.black);

        this.BRNinfoPanel.add(text);
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String cmd;
                if (id1.equals("")) {
                    cmd = "SELECT * FROM brn_holder_information";
                } else {
                    cmd = "SELECT * FROM brn_holder_information WHERE `Reg_No`='" + id1 + "'";
                }
        ...
        table = new JTable();
        ResultSet rz = GetData("SELECT * FROM brn_holder_information");
    ...
    public ResultSet GetData(String Command) {
        ...
        try {
            ...
            obj1.home.frame.add(this.BRNinfoPanel);
